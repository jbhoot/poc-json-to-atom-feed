This PoC generates a [W3C-compatible](https://validator.w3.org/feed/docs/atom.html) and [validated](https://validator.w3.org/feed/) Atom feed from an `index.json` file generated by the [static site generator soupault](https://soupault.app).
